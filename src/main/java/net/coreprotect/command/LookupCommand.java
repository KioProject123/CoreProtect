                                        ...
                                        if (finalCount) {
                                            ...
                                            if (finalArgAction.contains(6) || finalArgAction.contains(7)) { // Chat/command
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    Pair<HoverEvent<HoverEvent.ShowItem>, ItemStack> hoverEventWithItem = Util.getHoverEventWithItem(metadata, dtype, amount);
                                                    ...
                                                    Component nameComponent = LegacyComponentSerializer.legacySection().deserialize(Color.DARK_AQUA + rbd + ItemCN.getItemCN(dname, false));
