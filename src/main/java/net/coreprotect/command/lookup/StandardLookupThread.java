                    ...
                    if (count) {
                        ...
                        if (actions.contains(6) || actions.contains(7)) { // Chat/command
                            ...
                            for (String[] data : lookupList) {
                                ...
                                Chat.sendComponent(player, Color.WHITE + leftPadding + Color.GREY + "^ " + ChatUtils.getCoordinates(command.getName(), wid, dataX, dataY, dataZ, true, true, !dplayer.equals(player.getName()) && !player.hasPermission("coreprotect.teleport")) + "");
                            ...
                            for (String[] data : lookupList) {
                                ...
                                if (actions.contains(4) || actions.contains(5) || actions.contains(11) || amount > -1) {
                                    ...
                                    Chat.sendComponent(player, timeago + " " + tag + " " + Phrase.build(phrase, Color.DARK_AQUA + rbd + dplayer + Color.WHITE + rbd, Color.DARK_AQUA + rbd + (daction == 3 ? ItemCN.getEntityCN(dname) : ItemCN.getItemCN(dname)) + Color.WHITE, selector));
                                ...
                                Chat.sendComponent(player, Color.WHITE + leftPadding + Color.GREY + "^ " + ChatUtils.getCoordinates(command.getName(), wid, dataX, dataY, dataZ, true, true, !dplayer.equals(player.getName()) && !player.hasPermission("coreprotect.teleport")) + Color.GREY + Color.ITALIC + action);
                            }
                        }
